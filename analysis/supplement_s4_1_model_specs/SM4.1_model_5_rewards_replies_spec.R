# Purpose
# Document Model 5 specification: Replies (negative binomial MLM).
...
# Model specification
cat("=== MODEL 5: REPLIES (NEGATIVE BINOMIAL MLM) ===\n\n")
...
cat("Formula:\n")
cat("  reply_count ~ harmoniousness_raw + divisiveness_raw + (1|video_id)\n\n")
...
results <- list(
  ...
  formula = "reply_count ~ harmoniousness_raw + divisiveness_raw + (1|video_id)",
...
saveRDS(results, "analysis/supplement_s4_1_model_specs/SM4.1_model_5_rewards_replies_spec_results.rds")
